    ...
    <div id="footer">
        <div class="footer-left">
            <div class="footer-logo">
                <img src="image/FPTShop_logo.jpg" alt="" />
            </div>
            <div class="card_1">
...
<script>
    const open_st = document.querySelector(".fa-cog");
    const qt = document.querySelector(".qt");
    const width = document.querySelector(".qtv");
    open_st.addEventListener("click", () => {
        qt.classList.toggle("off_qt");
        width.classList.toggle("width");
    });

    const trash = document.querySelector(".fa-lg");
